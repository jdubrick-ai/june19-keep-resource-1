...
3) Access the `workbench` named `june19-keep-resource-1-notebook`.
...
5) In the terminal, run `cd june19-keep-resource-1` to navigate to your sample app's directory.
